...
import { startFetchingAction, stopFetchingAction } from "./components/stateManagement/actions/fetchingAction";
...
class App extends Component {
  constructor() {
    ...
    _defineProperty(this, "onKeyPress", () => {});

    _defineProperty(this, "onDelete", msg => {
      this.setState({
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Launcher, {
      agentProfile: {
